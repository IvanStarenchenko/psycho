	...
	return (
		...
		<section className="relative w-full min-h-[100dvh] pt-8 sm:pt-16 lg:pt-[81px] pb-28 sm:pb-32 lg:pb-[100px] flex flex-col items-start lg:items-center text-left lg:text-center overflow-hidden">
			...
			<Wrapper className="relative flex flex-col items-start lg:items-center w-full flex-1 z-10">
				...
				<h3 className="hero-subtitle leading-[130%] lg:leading-[120%] text-white/90! sm:text-white! text-left lg:text-center max-w-[808px] w-full mt-auto lg:mt-8 mb-6 lg:mb-0">
